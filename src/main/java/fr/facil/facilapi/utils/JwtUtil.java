...
public class JwtUtil {
    ...
    public String generateToken(AuthRequest user) {
        ...
        User userRep = repo.findUserByUsername(user.getUsername());

        claims.put("lastname", userRep.getLast_name());
        claims.put("firstname", userRep.getFirst_name());
        claims.put("permission", userRep.getPermission());
        claims.put("email", userRep.getEmail());

        return createToken(claims, userRep.getUsername());
    }
